...
// 
//
// Related Topics Array Dynamic Programming 👍 9166 👎 132
...
class Solution {
      ...
      public int rob(int[] nums) {
          ...
          int ans =  Math.max( f2(n-1, Arrays.copyOfRange(nums,1,n)), f2(n-1,Arrays.copyOfRange(nums,0,n-1)) );
          return ans;
      }
}
